...
class UniversalVariables {
  static final Color blueColor = Colors.indigo.shade300;
  ...
  static final Color lightBlueColor = Color(0xff868ED6);
  static final Color separatorColor = Color(0xff272c35);

  static final Color gradientColorStart = Color(0xff825ABC);
  static final Color gradientColorEnd = Color(0xffBDABEE);
