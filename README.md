...
A Flutter Application with video calling features (implemented using [agora.io](https://www.agora.io/en/ API) ), chatting feature along with user authentication.
